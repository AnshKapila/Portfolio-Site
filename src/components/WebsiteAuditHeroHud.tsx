...
export function WebsiteAuditHeroHud() {
  ...
  return (
    <div className="relative w-full aspect-square max-w-[500px] mx-auto select-none flex items-center justify-center p-4">
      ...
      >
        ...
        <g className="origin-center">
          ...
          <motion.circle 
            ...
            cy={cy} 
            r="120" 
            className="fill-none stroke-[#F24E1E]/20" 
            strokeWidth="1.5"
          ...
          <circle 
            ...
            cy={cy} 
            r="75" 
            className="fill-none stroke-[#F24E1E]/40" 
            strokeWidth="1.5"
          />
        </g>
          ...
          return (
            <g key={node.id}>
              ...
              <line 
                ...
                x2={targetX} 
                y2={targetY} 
                className={`transition-colors duration-300 ${isHovered ? 'stroke-[#F24E1E]/65' : 'stroke-zinc-800/60'}`}
              ...
              <motion.circle
                ...
                style={{ filter: "drop-shadow(0 0 4px #F24E1E)" }}
                animate={{
                  cx: [startX, targetX],
                  cy: [startY, targetY],
                  opacity: [0, 1, 1, 0]
            ...
            >
              ...
              {isHovered && (
                <circle 
                  ...
                  cy={ny} 
                  r="28" 
                  className="fill-[#F24E1E]/5 stroke-[#F24E1E]/20" 
                  strokeWidth="1"
                />
              )}
              ...
              <circle 
                ...
                cy={ny} 
                r="22" 
                className={`transition-all duration-300 ${isHovered ? 'fill-[#121212] stroke-[#F24E1E]' : 'fill-[#070707] stroke-zinc-800/80'}`}
                strokeWidth="1.5"
                style={{ 
              ...
              <circle 
                ...
                cy={ny} 
                r="18" 
                className="fill-none stroke-zinc-900/40" 
                strokeWidth="1"
              />
              ...
              <circle 
                cx={cx + (radius - 22) * Math.cos(angleRad)} 
                cy={cy + (radius - 22) * Math.sin(angleRad)} 
                r="2" 
                className={`transition-colors duration-300 ${isHovered ? 'fill-[#F24E1E]' : 'fill-zinc-600'}`}
              />
            </g>
          );
        })}
      ...
      <div 
        className="absolute w-[130px] h-[105px] bg-[#0c0c0e]/90 border border-white/10 rounded-lg shadow-[0_0_35px_rgba(242,78,30,0.15)] flex flex-col overflow-hidden group transition-all duration-500 hover:border-[#F24E1E]/30"
        ...
        <div className="p-2.5 flex-1 flex flex-col justify-between relative overflow-hidden bg-black/80">
          ...
          >
            ...
            <motion.path 
              ...
              stroke="#FF8354"
              strokeWidth="1.5"
              filter="drop-shadow(0 0 5px #F24E1E)"
              animate={{
