            ...
            <div className="flex flex-col p-6 gap-6">
              ...
              <div className="pt-4 border-t border-white/10 mt-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full inline-flex items-center justify-center px-6 py-4 rounded-lg text-base font-medium bg-white text-black hover:bg-gray-200 transition-colors"
                >
                  Book a Call
                </a>
              </div>
