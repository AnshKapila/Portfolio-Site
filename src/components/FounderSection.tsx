      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative w-full rounded-[2.5rem] bg-[#F24E1E] p-8 md:p-12 shadow-2xl overflow-hidden flex flex-col lg:flex-row items-center gap-10 border border-white/5">
          ...
          <motion.div
            ...
            className="w-full lg:w-80 shrink-0 bg-[#0a0a0a] rounded-[2rem] p-7 shadow-2xl border border-white/10 relative z-10 lg:self-stretch flex flex-col justify-center"
          >
