...
export function WebsiteAuditTeaser() {
  ...
  return (
    <section className="py-24 px-6 md:px-12 lg:px-16 border-t border-b border-white/5 bg-gradient-to-b from-black to-zinc-950/40 relative overflow-hidden" id="website-audit-teaser">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 lg:gap-24 items-center">
        ...
        <div className="lg:w-7/12 space-y-6">
          ...
          <motion.h2
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-heading italic tracking-tight leading-tight text-white"
          >
          ...
          <motion.div
            ...
            className="space-y-4 text-base md:text-lg font-light leading-relaxed text-zinc-400"
          >
            <p>
        ...
        <div className="lg:w-5/12 w-full">
          <motion.div
            ...
            className="p-8 md:p-10 rounded-2xl border border-white/10 bg-zinc-900/40 relative overflow-hidden backdrop-blur-sm"
          >
            ...
            <div className="space-y-6 mb-8">
              ...
              <ul className="space-y-4">
                {highlights.map((highlight, idx) => (
                  <li key={idx} className="flex items-start gap-3.5 text-zinc-200 font-light text-sm md:text-base leading-snug">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/audit"
                className="bg-white text-black px-6 py-3 rounded-lg font-medium text-sm hover:bg-gray-200 transition-colors inline-flex items-center gap-2 justify-center group shrink-0"
              >
                View Website Audit
