...
export function SocialPresenceSection() {
  return (
    <section id="public-notes" className="py-24 px-6 md:px-12 lg:px-16 bg-black relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-16 md:mb-20">
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-xs text-[#F24E1E] uppercase tracking-[0.25em] font-bold mb-4"
          >
            Beyond the Studio
          </motion.p>
          ...
          <motion.h2
            ...
            className="text-4xl md:text-5xl lg:text-6xl font-heading italic tracking-tight text-white"
          >
          ...
          <motion.p
            ...
            className="text-gray-400 font-light text-lg md:text-xl max-w-2xl mt-5 leading-relaxed"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            className="lg:col-span-2 group relative rounded-[2rem] bg-zinc-950/60 border border-white/10 p-8 md:p-10 flex flex-col justify-between overflow-hidden transition-all duration-500 hover:border-[#F24E1E]/30"
          >
          ...
          <motion.div
            ...
            className="lg:col-span-1 group relative rounded-[2rem] bg-zinc-950/60 border border-white/10 p-8 flex flex-col justify-between overflow-hidden transition-all duration-500 hover:border-[#F24E1E]/30"
          >
            ...
            <a
              href="https://www.behance.net/anshkapila"
              target="_blank"
              rel="noopener noreferrer"
              className="w-full inline-flex items-center justify-between px-5 py-3 border border-white/10 hover:border-white/30 rounded-xl font-medium text-sm text-white group-hover:bg-white/5 transition-all duration-300"
            >
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8 items-center">
              ...
              <div className="md:col-span-2">
                ...
                <a
                  href="https://www.instagram.com/anshkapila.ux/"
                  target="_blank"
                  rel="noopener noreferrer"
