...
const allProjects: Project[] = [
  {
    ...
    coverImage: (fintrackCover as any)?.src || (fintrackCover as any),
    ...
    detailImage1: (fintrackDetail1 as any)?.src || (fintrackDetail1 as any),
    detailImage2: (fintrackDetail2 as any)?.src || (fintrackDetail2 as any),
    ...
    buttonLink: "#",
    bannerImage: (fintrackBanner as any)?.src || (fintrackBanner as any),
    hidden: true
  },
  {
    ...
    coverImage: (sulipsaCover as any)?.src || (sulipsaCover as any),
    ...
    detailImage1: (sulipsaDetail1 as any)?.src || (sulipsaDetail1 as any),
    detailImage2: (sulipsaDetail2 as any)?.src || (sulipsaDetail2 as any),
  ...
  },
  {
    ...
    coverImage: (bergariaCover as any)?.src || (bergariaCover as any),
    ...
    detailImage1: (bergariaDetail1 as any)?.src || (bergariaDetail1 as any),
    detailImage2: (bergariaDetail2 as any)?.src || (bergariaDetail2 as any),
  ...
  },
  {
    ...
    coverImage: (damacCover as any)?.src || (damacCover as any),
    ...
    detailImage2: (damacDetail2 as any)?.src || (damacDetail2 as any),
    outcomeHeading: "Outcome",
    ...
    bannerImage: (damacBanner as any)?.src || (damacBanner as any)
  }
];
